...
// LCAP identity uses the legacy misspelling "bridege". Convert its kebab-case
// package name to the historical UMD global ReshineUniappMobileBridegeLibrary.
...
export default defineConfig(({ command }) => {
  ...
  return {
    ...
    test: {
      ...
      coverage: {
        include: ['src/bridge/**/*.ts', 'src/logics/**/*.ts'],
